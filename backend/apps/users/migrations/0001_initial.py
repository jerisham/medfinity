    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('patient', 'Patient'), ('doctor', 'Doctor'), ('pharmacist', 'Pharmacist'), ('caregiver', 'Caregiver')], default='patient', max_length=20)),
                ...
                ('pharmacy_license', models.CharField(blank=True, max_length=50)),
