...
if (loginForm){
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      window.location.href = DASHBOARD_BY_ROLE[user.user_type] || 'patient_dashboard.html';
    } catch (err){
...
if (registerForm){
  registerForm.addEventListener('submit', async (e) => {
    ...
    const payload = {
      ...
      password2: registerForm.password2 ? registerForm.password2.value : registerForm.password.value, // Added password2
    };
